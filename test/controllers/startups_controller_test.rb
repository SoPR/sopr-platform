...
class StartupsControllerTest < ActionController::TestCase
  ...
  test "should create startup" do
    assert_difference('Startup.count') do
      post :create, startup: { market: @startup.market, name: @startup.name, pitch: @startup.pitch, product: @startup.product, website: @startup.website }
    end
  ...
  test "should update startup" do
    patch :update, id: @startup, startup: { market: @startup.market, name: @startup.name, pitch: @startup.pitch, product: @startup.product, website: @startup.website }
    assert_redirected_to startup_path(assigns(:startup))
  end
