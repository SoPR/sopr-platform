# RailsAdmin config file. Generated on June 29, 2013 22:06
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Sopr Platform', 'Admin']
  ...
  # config.excluded_models = ['Startup', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Startup', 'User']
  ...
  #     configure :pitch, :string
  #     configure :website, :string
  #     configure :product, :string
